  ...
  useEffect(() => {
    if (monto && modalidadCredito && tipologia) {
      ...
      console.log("📌 Iniciando cálculos con:", {
        monto: montoNum,
        modalidad: modalidadCredito, // 🟢 Verificar que llega con valor
        tipologia,
      });
      ...
      // 🔹 Verificar antes de llamar a calcularComisionMipyme
      if (modalidadCredito) {
        console.log("📌 Modalidad antes de calcular MiPyme:", modalidadCredito);
        const comisionMipyme = calcularComisionMipyme(
          montoNum,
          modalidadCredito
        );
        ...
        console.warn("⚠️ Modalidad es undefined antes de calcular MiPyme.");
      }
    }
